...
// Diff B/w String Builder and String Buffer
//  The main difference between a string builder and a string buffer is that a string buffer is thread-safe, while a string builder is not:
